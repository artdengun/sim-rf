...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/vendors/index").hasAnyAuthority( "MANAJER", "LEADER")
                .antMatchers("/vendors/tambah").hasAnyAuthority( "MANAJER","LEADER")
                .antMatchers("/vendors/edit").hasAnyAuthority("MANAJER","LEADER")
                // REPORTING
                .antMatchers("/vendors/export/excel").hasAnyAuthority("MANAJER")
                .antMatchers("/vendors/export/pdf").hasAnyAuthority("MANAJER")
